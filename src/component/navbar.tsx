...
const Navbar = () => {
  return (
    <section className="sticky top-0 h-[63px] w-full flex items-center justify-between border-b-2 border-gray-300 px-4 md:px-6 backdrop-blur-lg capitalize z-30">
