    ...
    <section>
      <footer className="mx-auto w-full max-w-[64rem] flex flex-col gap-2 pt-8 text-center text-sm capitalize">
        ...
        <p className="pb-6 px-8 text-xs">
          © 2025 Santa Cruz Parish Youth Ministry. This website is not
          officially affiliated with the Diocese of Novaliches or any other
          governing religious institution. The views and content shared here are
          created by and for the Youth Community and do not necessarily
          represent the official stance of the Catholic Church.
        </p>
      </footer>
    </section>
  );
